...
public class ZkNodeUtils {
    ...
    public static String getBasePath(String clusterName) {
    ...
    public static Node parse(String clusterName, String fullPath) {
        ...
        String nodeType = getMatcher(getBasePath(clusterName) + "/(.*)/", fullPath);
        node.setNodeType(NodeType.valueOf(nodeType));

        String url = getMatcher(getBasePath(clusterName) + "/" + nodeType + "/" + nodeType + ":\\\\\\\\(.*)", fullPath);
    ...
    public static String getPath(String clusterName, Node node) {
        StringBuilder path = new StringBuilder();
        path.append(getBasePath(clusterName))
                .append("/")
