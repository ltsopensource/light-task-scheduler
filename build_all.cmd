...
rem start mvn clean install -DskipTests
...
set TASK_TRACKER_START_UP_DIR=%BASE_HOME%\lts-startup\lts-startup-tasktracker
cd %TASK_TRACKER_START_UP_DIR%
start mvn assembly:assembly -DskipTests
echo "LTS: mvn assembly:assembly -DskipTests"
echo "LTS: After sub window finished, close it , and press any key to continue" & pause>nul

xcopy /e /y "%TASK_TRACKER_START_UP_DIR%\target\lts-bin\lts" "%LTS_BIN_DIR%"
cd ..\..\
