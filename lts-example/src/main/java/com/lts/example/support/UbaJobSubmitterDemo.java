...
import com.lts.tasktracker.jobdispatcher.*;
...
public class UbaJobSubmitterDemo implements JobSubmitter {
    ...
    protected static final Logger LOGGER = LoggerFactory.getLogger(com.lts.tasktracker.jobdispatcher.JobRunnerDispatcher.class);
